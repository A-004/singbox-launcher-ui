...
- **Preset DNS reorder** аналогично. → **SPEC 062-F-N WIZARD_DNS_RULES_UNIFIED_ORDER** покрывает этот пункт (унифицирует preset + user DNS-rules в один ordered list с drag ↑↓ контролами).
